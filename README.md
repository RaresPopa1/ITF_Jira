# ITF_Jira
ITF_1st_Project_Orange_HRM
1. Test Plan (care sa cuprinda toate informatiile aferente)
2. Release care sa cuprinda epics, stories si, daca e cazul, tasks si subtasks
3. Test case-uri (cel putin 10, dar recomandam cat mai multe cu putinta, astfel incat sa aveti o sansa cat mai mare la angajare)
4. Bug-uri - ele reprezinta cartea de vizita a unui tester, deci incercati sa gasiti cat de multe puteti
5. Raport de status generat din Zephyr - Test Metrics - Primul raport din lista. Acest raport va contine activitatea zilnica motiv pentru care, pana terminti proiectul, recomand rularea testelor zilnic sau aproape zilnic astfel incat sa se reflecte o activitate constanta in acel raport
6. Cycle summary 
7. Matrice de trasabilitate
8. Raport de executie
Optional: documentul cu review-ul cerintelor de business
